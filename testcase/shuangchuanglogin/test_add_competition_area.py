# -*-coding = utf-8 -*-
'''
@File    :  test_add_competition_area.py
@Time    :  2022-11-23 2:38
...
# class TestAddCompetitionArea:
    ...
    # def test_login(self, get_token, connect_db):  # 登录接口测试函数(自动化测试用例)，login.xlsx叫手工测试用例或者测试数据
